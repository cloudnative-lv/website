    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-pink-light overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-24 text-center">
          <img src="/images/logo.png" alt="Cloud Native Latvia" className="h-32 w-auto mx-auto mb-6" />
          ...
          <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
            A community of cloud native enthusiasts in Latvia. Join us for bi-monthly meetups 
            exploring Kubernetes, observability, platform engineering, and more.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            We are a community of developers, DevOps engineers, and cloud enthusiasts based in Latvia. 
            Our mission is to share knowledge and experiences around cloud native technologies including 
            Kubernetes, containers, microservices, observability, and platform engineering.
          </p>
          <p className="text-lg text-gray-600 leading-relaxed">
            We meet bi-monthly (every 2 months) in Riga to hear talks from local and international 
            speakers, network with fellow practitioners, and learn together.
          </p>
        </div>
      </section>

      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-rose-400 to-rose-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
