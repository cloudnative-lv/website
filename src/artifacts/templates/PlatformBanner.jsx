...
export default function PlatformBanner({ width, height, tagline = TAGLINE }) {
  ...
  if (width / height >= 4) {
    return (
      <BannerFrame width={width} height={height} skylineSrc={skylineSimple} skylinePos="cover-top" skylineClass="opacity-25">
  ...
  return (
    <BannerFrame width={width} height={height} skylineSrc={skylineSimple} skylinePos="cover-top" skylineClass="opacity-30">
